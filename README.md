## TODO:
- [x] Use Meta's SAM to initialize TAPIR with mask [(adapted from Roboflow)](https://colab.research.google.com/github/roboflow-ai/notebooks/blob/main/notebooks/how-to-segment-anything-with-sam.ipynb#scrollTo=1H9YruJen0Q8)
